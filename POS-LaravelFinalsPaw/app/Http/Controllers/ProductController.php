...
class ProductController extends Controller
{
    ...
    public function cetak(Request $request){
        ...
        return view('products.cetak') ->with('products', $products);

    }

    public function editStok(Product $product)
    {
        return view('stok.edit')->with('product', $product);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateStok(ProductUpdateRequest $request, Product $product)
    {
        $product->name = $request->name;
        $product->description = $request->description;
        $product->barcode = $request->barcode;
