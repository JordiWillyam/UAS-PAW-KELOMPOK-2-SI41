        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="order: 1; flex: 1;">{{ __('Register') }}</span>
                    <a href="{{ url('/') }}" class="btn btn-link" style="color: white; background-color: red; padding: 6px 14px; border-radius: 4px; text-decoration: none; order: 2;">
                        Quit
                    </a>
                </div>
                <div class="card-body">
